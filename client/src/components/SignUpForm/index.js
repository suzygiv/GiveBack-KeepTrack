...
class Form extends Component {
  ...
  handleSubmit = (event) => {
    ...
    axios
      ...
      .catch((error) => {
        this.setState({
          errorMessage: "Your email address and password already exist",
        });
        console.log(error);
      });
  };
            ...
            <Row>
              ...
              <Col size="lg-4">
                <div>
                  ...
                  <p className="catch-phrase catch-phrase-spacing">
                  ...
                  <div>
                    ...
                    <img
                      ...
                      src={
                        ...
                        "/images/icon-circles-removebg.png"
                      }
                      to="/welcome"
                      width="170"
                      height="72"
